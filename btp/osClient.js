...
const destinationUrl = "/destination-configuration/v1/destinations/OSA4H";

let connectivityAccessToken = null;
let destinationConfig = null;


const initOsClient = async () => {
...
const callOsService = async (resource, params, destination, connectivityToken) => {
...
module.exports = {
    initOsClient: initOsClient,
    callOsService: callOsService
}